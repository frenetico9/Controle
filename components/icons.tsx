...
export const TransactionsIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h.01M12 7h.01M16 7h.01M9 17h6M9 13h6M9 9h6M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z" />
  </svg>
);
...
export const WalletIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 0 0-2.25-2.25H5.25a2.25 2.25 0 0 0-2.25 2.25m17.5 0-1.875.938-2.227 4.454-2.112-1.056-2.227-4.454-1.875-.938m10.313.063-1.875-.937-2.227-4.454-2.112 1.056-2.227 4.454-1.875.938M4.5 12.063l1.875.937 2.227 4.454 2.112-1.056 2.227 4.454 1.875-.938m-10.313 0l1.875-.937 2.227-4.454 2.112 1.056 2.227 4.454 1.875-.938" />
    </svg>
);
